...
func (r *RedisRepository) PublishMessage(channel string, message interface{}) error {
...
func (r *RedisRepository) AddToOutbox(queue string, message interface{}) error {
	msg, err := json.Marshal(message)
	if err != nil {
		return err
	}
...
func (r *RedisRepository) ProcessOutbox(queue string, processFunc func(string) error) {
	for {
